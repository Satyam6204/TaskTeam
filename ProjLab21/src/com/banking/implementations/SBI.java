...
public class SBI implements IBank{
	...
	public String deposit(double amount) throws InvalidInputException{
		if(amount>0 && amount<=50000) {
			this.amount+=amount;
			return "Afetr deposited "+amount+" in SBI current balance : "+this.amount ;
		} else 
	...
	public String withdraw(double amount) throws InSufficientBalanceException,InvalidInputException{
		if(amount<=0) {
			...
			this.amount-=amount;
			return "Afetr withdrawl "+amount+" in SBI current balance : "+this.amount;
		}
	}

	@Override
	public String toString() {
		return "SBI currentBalance : " + amount+"\n";
	}
