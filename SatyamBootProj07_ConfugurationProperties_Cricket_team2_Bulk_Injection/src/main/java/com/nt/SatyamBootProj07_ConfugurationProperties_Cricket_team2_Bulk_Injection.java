...
import com.nt.DAO.Team;

@SpringBootApplication
public class SatyamBootProj07_ConfugurationProperties_Cricket_team2_Bulk_Injection {

	public static void main(String[] args) {
		ApplicationContext ctx=SpringApplication.run(SatyamBootProj07_ConfugurationProperties_Cricket_team2_Bulk_Injection.class, args);
		
		Team t=ctx.getBean("Allteam",Team.class);
		System.out.println("TEAM ID\t\t\t:"+t.getId());
		System.out.println("TEAM NAME\t\t:"+t.getName());
		System.out.println("TEAM CAPTAIN\t\t:"+t.getCaptain());
		System.out.println("TEAM COACH\t\t:"+t.getCoach());
