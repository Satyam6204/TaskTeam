...
import com.nt.sbeans.TeamDAO;

@SpringBootApplication
public class SatyamBootProj01ConfugurationPropertiesCricketBulkInjectionAndUseProfileApplication {

	public static void main(String[] args) {
	ConfigurableApplicationContext ctx=	SpringApplication.run(SatyamBootProj01ConfugurationPropertiesCricketBulkInjectionAndUseProfileApplication.class, args);
	
	TeamDAO td =ctx.getBean("teamd",TeamDAO.class);
